...
ADAPTERS = {
    ...
    "ours_spk": (make_run_adapter("transcript_speakers.json"), "transcript_speakers.json"),
    "ours_spk_rule": (make_run_adapter("transcript_speakers_rule.json"),
                      "transcript_speakers_rule.json"),
